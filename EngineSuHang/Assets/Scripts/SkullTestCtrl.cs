...
public class SkullTestCtrl : MonoBehaviour
{
    ...
    /// 함수 동작은 목표물이 들어오면 목표물을 설정하고 해골을 타게 위치로 이동시킨다.
    /// </summary>
    /// <param name="target">목표물</param>
    void OnCKTarget(GameObject target)
    {
        //목표 캐릭터에 파라매터로 검출된 오브젝트를 넣는다.
    ...
    void effectDamageTween()
    {
        ...
        //트윈의 타갯은 스킨메쉬렌더러, 시간은 0.2초, 파라메터로는 색상, 반복.콜백함수
